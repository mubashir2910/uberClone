const RidePopUp = (props) => {
  ...
  <div>
    ...
    <h3 className='text-xl text-center font-semibold mb-4'>New Ride Available!</h3>
    ...
    <div>      
        ...
        <div className="flex justify-between gap-6">
            <button onClick={()=>{props.setRidePopUpPanel(false);props.setConfirmRidePopUpPanel(true)}}
            className="w-full bg-yellow-500 text-white font-semibold p-2 rounded-xl">Accept</button>
            <button onClick={()=>{props.setRidePopUpPanel(false)}}
            className="w-full bg-gray-400 text-white font-semibold p-2 rounded-xl">Ignore</button>
        </div> 
