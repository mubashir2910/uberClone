...
const FinishRide = (props) => {
  ...
  <div>
    ...
    <h3 className='text-2xl text-center font-semibold mb-4'>Finish this Ride</h3>
    ...
    <div>      
        ...
        <div className="absolute bottom-0 left-0 w-full p-4">
            ...
            className="flex justify-center w-full bg-green-500 text-white text-lg font-semibold p-2 rounded-xl">Finish Ride</Link>  
            <p className="text-sm text-red-600"><i className="ri-error-warning-line"></i> Click the Finish Ride button after receiving payment from the customer.</p>          
        </div> 
