...
//   const [email, setEmail] = useState("");
//   const [password, setPassword] = useState("");
//   const { setCaptain } = useContext(CaptainDataContext);  // ✅ use new updater
//   const navigate = useNavigate();
...
//         setCaptain(data.captain);   // ✅ context + localStorage update
...
//           Join the Fleet ! &nbsp;
//           <Link to="/captains/register" className="text-blue-600 underline">
